...
parser = argparse.ArgumentParser(description="Scan JS bundles for keywords.")
parser.add_argument("search_dir", nargs="?", default=os.path.join(os.path.dirname(__file__), "..", "..", "osint_links", "Zohar_Toolkit", "Intelligence_Database", "OpenAI", "Backend_Code", "Frontend_JS_Bundles"), help="Directory to search for JS files.")
