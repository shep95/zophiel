...
parser = argparse.ArgumentParser(description="Verify actuator and server-status endpoints.")
parser.add_argument("findings_file", nargs="?", default=os.path.join(os.path.dirname(__file__), "..", "..", "osint_links", "Intelligence_Database", "X_Corp", "Reports", "CONFIG_FUZZ_FINDINGS.json"), help="Path to the CONFIG_FUZZ_FINDINGS.json file.")
